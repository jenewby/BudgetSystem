...
namespace BudgetSystem.Models.Helpers
{
    ...
    public class AuthorizedHouseholdRequired : AuthorizeAttribute
    {
            ...
            protected override void HandleUnauthorizedRequest(AuthorizationContext filterContext)
        {
            ...
            {
                filterContext.Result = new RedirectToRouteResult(new RouteValueDictionary(new { controller = "Home", action = "CreateJoinHoushold" }));
            }
        }
